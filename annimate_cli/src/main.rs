...
impl From<QueryLanguage> for annimate_core::QueryLanguage {
    fn from(value: QueryLanguage) -> Self {
        match value {
            QueryLanguage::Aql => annimate_core::QueryLanguage::AQL,
            QueryLanguage::AqlQuirksV3 => annimate_core::QueryLanguage::AQLQuirksV3,
        }
    }
}

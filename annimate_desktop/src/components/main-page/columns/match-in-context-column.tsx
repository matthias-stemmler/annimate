    ...
    <ColumnConfigGrid>
      ...
      <ColumnConfigItem>
        ...
        <SegmentationAnnoSelect
          ...
          hasDefault={data.segmentation !== undefined}
          id={annoSelectId}
...
export type SegmentationAnnoSelectProps = {
  annoKey: AnnoKey | null | undefined;
  hasDefault: boolean;
  id?: string;
  onChange?: (annoKey: AnnoKey | null) => void;
};
...
export const SegmentationAnnoSelect: FC<SegmentationAnnoSelectProps> = ({
  ...
  return (
    <Select
      ...
      loading={isPending}
      onChange={(value) =>
        onChange?.(value === DEFAULT_VALUE ? null : valueToAnnoKey(value))
      }
      options={[
        {
          groupKey: 'other',

  ...
  >
    ...
    <div className="flex h-96 flex-col gap-6">
      <ScrollArea className="h-full rounded-md border">
        <div className="prose prose-sm dark:prose-invert prose-a:text-blue-800 m-3 cursor-text select-text">
          <Markdown components={{ a: ExternalAnchor }}>{update.notes}</Markdown>
        </div>
      </ScrollArea>

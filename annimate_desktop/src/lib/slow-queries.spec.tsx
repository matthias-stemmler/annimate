...
describe('slow-queries', () => {
  ...
  const TestQuery: FC<TestQueryProps> = ({
    ...
    const { data, isPending } = useSlowTrackingQuery({
    ...
    return (
      <div data-testid={testId}>{JSON.stringify({ data, isPending })}</div>
    );
  };
  ...
  it('should track "slow" state of queries', async () => {
    ...
    expectOutput([
      { testId: 'output1', expected: { isPending: true, data: undefined } },
      { testId: 'output2', expected: { isPending: true, data: undefined } },
    ]);
    ...
    expectOutput([
      { testId: 'output1', expected: { isPending: false, data: 'A' } },
      { testId: 'output2', expected: { isPending: false, data: 'A' } },
    ]);
    ...
    await advanceTimers(1);
    expectOutput([
      { testId: 'output1', expected: { isPending: false, data: 'B' } },
      { testId: 'output2', expected: { isPending: false, data: 'B' } },
    ]);
    ...
    await advanceTimers(1);
    expectOutput([
      { testId: 'output1', expected: { isPending: false, data: 'C' } },
    ]);

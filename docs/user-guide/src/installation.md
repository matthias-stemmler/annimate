...
1. Download the installer `.exe` file from GitHub: [Annimate_1.3.4_x64-setup.exe][1]
...
1. Download the `.AppImage` file from GitHub: [Annimate_1.3.4_amd64.AppImage][2]
...
1. Download the `.deb` file from GitHub: [Annimate_1.3.4_amd64.deb][3]
2. Install it:
   ```shell
